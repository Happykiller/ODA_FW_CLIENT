...
test( "$.Oda.Storage.get", function( assert ) {
...
test( "$.Oda.Storage.getTtl", function( assert ) {
...
test( "$.Oda.Storage.setTtl", function( assert ) {
...
test( "$.Oda.Storage.remove", function( assert ) {
...
test( "$.Oda.Storage.reset", function( assert ) {
